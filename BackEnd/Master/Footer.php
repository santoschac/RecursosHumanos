<div class="footer-copyright-area">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Corah 2019. Corporativo de alumninios y herrajes.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- counterup JS
		============================================ -->
    <script src="../Recursos/js/counterup/jquery.counterup.min.js"></script>
    <script src="../Recursos/js/counterup/waypoints.min.js"></script>
    <script src="../Recursos/js/counterup/counterup-active.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    ...
    <!-- morrisjs JS
		============================================ -->
    <script src="../Recursos/js/morrisjs/raphael-min.js"></script>
    <script src="../Recursos/js/morrisjs/morris.js"></script>
    <script src="../Recursos/js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
