                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="Vacaciones.php">Vacaciones</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Agregar Vacaciones</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Agregar vacaciones</a></li>
                                            ...
                                            <div class="review-content-section">
                                                <form  method="POST" id="formulario" class="add-department">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Título</label>
                                                            <input name="Titulo" id="Titulo" value="" type="text" class="form-control" placeholder="Escribe un título">
                                                        </div>
                                                        ...
                                                        </div> <div class="form-group data-custon-pick">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light">Guardar</button>
                                                                    <a href="Vacaciones.php"  class="btn btn-success waves-effect waves-light">Regresar</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-cookie="true"
                                        ...
                                        <?php foreach ($resultado as $dato) {?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="VAlta_Vacaciones.php?IdPersonal=<?php echo $dato['IdPersonal']; ?>"><button data-toggle="tooltip" class="pd-setting-ed"><span class="glyphicon">&#xe013;</span></button><a>
