...
$sql1 = 'SELECT pe.IdPermiso, pe.Dia, pe.Descripcion, pe.Devolucion, pe.IdPersonal, p.Nombre, p.ApellidoPaterno, p.ApellidoMaterno, pu.NombrePuesto, s.NombreSucursal, e.IdEmpresa, e.NombreEmpresa
from permisos pe
inner join personal p on pe.IdPersonal = p.IdPersonal
inner join puestos pu on p.IdPuesto = pu.IdPuesto
inner join sucursal s on p.IdSucursal = s.IdSucursal
inner join empresa e on s.IdEmpresa = e.IdEmpresa where IdPermiso = :IdPermiso';
$sentencia=$pdo->prepare($sql1);
$sentencia->execute(['IdPermiso'=>$IdPermiso]);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="Permisos.php">Permisos</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Actualizar permiso</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Actualizar Permiso</a></li>
                                            ...
                                            <div class="review-content-section">
                                                <form  method="POST" id="formulario" class="add-department">
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" name="IdPermiso" id="IdPermiso" value="<?php echo $IdPermiso?>">
                                                        <div class="form-group">
                                                            <label class="control-label" for="Personal">Personal</label>
                                                            <input type="hidden" name="IdPersonal" id="IdPersonal" value="<?php if(isset($_GET['IdPermiso'])):?><?=$permisos->IdPersonal;?><?php endif;?>" >
                                                           
                                                                <input type="text" name="Personal" id="Personal" class="form-control" placeholder="Nombre Personal"
                                                                    required="" value="<?php if(isset($_GET['IdPermiso'])):?><?=$permisos->Nombre ." ". $permisos->ApellidoPaterno ." ". $permisos->ApellidoMaterno;?><?php endif;?>"
                                                        ...
                                                        <div class="form-group">
                                                            <label>Empresa</label>
                                                            <input name="EmpresaAnterior" id="EmpresaAnterior" value="<?php if(isset($_GET['IdPermiso'])):?><?=$permisos->NombreEmpresa?><?php endif;?>" type="text" class="form-control" placeholder="Empresa anterior" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Sucursal</label>
                                                            <input name="SucursalAnterior" id="SucursalAnterior" value="<?php if(isset($_GET['IdPermiso'])):?><?=$permisos->NombreSucursal?><?php endif;?>" type="text" class="form-control" placeholder="Sucursal anterior" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Puesto</label>
                                                            <input name="PuestoAnterior" id="PuestoAnterior" value="<?php if(isset($_GET['IdPermiso'])):?><?= $permisos->NombrePuesto?><?php endif;?>" type="text" class="form-control" placeholder="Puesto anterior" readonly>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
																	...
																	<div class="input-group date">
																		...
																		<input type="date" name="Dia" id="Dia" class="form-control" value="<?php echo date("Y-m-d", strtotime($permisos->Dia)); ?>">
																	</div>
                                                                </div>
                                                                ...
                                                                <label>Forma de devolución</label>
                                                                    <select name="Devolucion" id="Devolucion" class="form-control" >
																		...
																		<option value="Cuenta de vacaciones" <?php if("Cuenta de vacaciones"===$permisos->Devolucion): echo "Selected"; endif;?> >Cuenta de vacaciones</option>
																		<option value="Devolución de días" <?php if("Devolución de días"===$permisos->Devolucion): echo "Selected"; endif; ?>>Devolución de días</option>
																	</select>
                                                                </div>
                                                                <div class="form-group res-mg-t-15">
                                                        <label>Descripción</label>
                                                        <textarea name="Descripcion" id="Descripcion"
                                                            placeholder="Descripcion" required="" maxlength="148" ><?= $permisos->Descripcion?></textarea>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light">Actualizar</button>
                                                                    <a href="Permisos.php"  class="btn btn-success waves-effect waves-light">Regresar</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-cookie="true"
                                        ...
                                        <?php foreach ($resultado as $dato) {?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="VAlta_Permiso.php?IdPersonal=<?php echo $dato['IdPersonal']; ?>"><button data-toggle="tooltip" class="pd-setting-ed"><span class="glyphicon">&#xe013;</span></button><a>
