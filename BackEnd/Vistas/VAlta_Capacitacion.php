                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Agregar Capacitación</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Agregar Capacitación</a></li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group data-custon-pick">
                                                            ...
                                                            <div class="input-group date">
                                                                ...
                                                                <input type="date" name="FechaCapacitacion" id="FechaCapacitacion" class="form-control" value="<?php echo date("Y-m-d"); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Curso</label>
                                                            ...
                                                            <option value="" selected="" disabled="">Seleccionar</option>
                                                                <?php foreach ($result as $dato) {?>
                                                                    <option value="<?php echo $dato['IdCurso'];?>"> <?php echo $dato['Nombre']; ?> </option>
                                                                <?php } ?>
                                                            </select>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-cookie="true"
                                        ...
                                        <?php foreach ($resultado as $dato) {?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="VAlta_Capacitacion.php?IdPersonal=<?php echo $dato['IdPersonal']; ?>"><button data-toggle="tooltip" class="pd-setting-ed"><span class="glyphicon glyphicon-ok"></span></button><a>
...
//alert(datos);
               ...
               $.ajax({
                   url:"Alta/Alta_Capacitacion.php",
                   method:'POST',
