                                            ...
                                            <div class="review-content-section">
                                                <form  method="POST" id="formulario" class="add-department">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Empresa </label>
                                                            <input name="Empresa" id="Empresa" value="<?php if(isset($_GET['IdPersonal'])):?><?=$Personal->NombreEmpresa?><?php endif;?>" type="text" class="form-control" placeholder="Empresa anterior" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Sucursal</label>
                                                            <input name="Sucursal" id="Sucursal" value="<?php if(isset($_GET['IdPersonal'])):?><?=$Personal->NombreSucursal?><?php endif;?>" type="text" class="form-control" placeholder="Sucursal anterior" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Puesto</label>
                                                            <input name="Puesto" id="Puesto" value="<?php if(isset($_GET['IdPersonal'])):?><?= $Personal->NombrePuesto?><?php endif;?>" type="text" class="form-control" placeholder="Puesto anterior" readonly>
                                                        </div>
...
//alert(datos);
               ...
               $.ajax({
                   url:"TablasModal/TablaPersonalAsignarJornada.php",
                   method:'POST',
                   data:new FormData(this),
                   contentType:false,
                   processData:false,
