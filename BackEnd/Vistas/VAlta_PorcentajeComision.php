                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Agregar Porcentaje</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Agregar Porcentaje</a></li>
                                                ...
                                                <form  method="POST" id="formulario" class="add-department">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="Porcentaje" id="Porcentaje"class="form-control" required onkeypress="return numeros(event)" maxlength="4">
...
$(document).ready(function(){
 ...
 $(document).on('submit', '#formulario', function(event){
           ...
           var datos = $('#formulario').serialize();
               ...
               $.ajax({
                   url:"Alta/Alta_PorcentajeComision.php",
                   method:'POST',
...
//alert(datos);
               ...
               $.ajax({
                   url:"TablasModal/TablaPersonalPorcentajeComision.php",
                   method:'POST',
                   data:new FormData(this),
                   contentType:false,
                   processData:false,
