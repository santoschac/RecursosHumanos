...
inner join solicitudes s on p.IdPersonal = s.IdPersonal where s.IdPersonal = $IdPersonal order by IdSolicitudes desc") ;
$sql->execute();
 ...
 <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <?php foreach ($result as $dato) {?>
                                            <tr>
                                                ...
                                                <td><a href="../VistasU/Documentos/<?php echo $dato['Usuario']?>/<?php echo $dato['Documento']?>" download="<?php $dato['Documento']?>"><?php if(isset($dato['Documento'])):?><img src="../VistasU/Documentos/descargaricono.png" width="90px" height="90px" alt=""><?php endif;?></a></td>
                                                <td>
