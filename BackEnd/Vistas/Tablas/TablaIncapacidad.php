...
$sql= $pdo->prepare("SELECT p.Nombre, p.ApellidoPaterno, p.ApellidoMaterno, u.Usuario, i.IdIncapacidad, i.DiaInicio, i.DiaFinal, i.Descripcion, i.Documento, i.IdPersonal
FROM personal p
