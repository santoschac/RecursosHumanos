...
<div id="TablaPermisosEmpleado"></div> <!-- products will be load here -->
                                    ...
                                    <div class="modal-body">
									   ...
									   <div class="form-group">
                                                                    ...
                                                                    <div class="input-group date"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                        <input type="date" name="Dia" id="Dia" class="form-control" value="<?php echo date("Y-m-d") ?>" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <textarea name="Descripcion" id="Descripcion"
                                                                    placeholder="Descripción del permiso" readonly ></textarea>
                                                            </div>    
									   ...
									   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <label>Forma de devolución</label>
                                                                    <select name="Devolucion" id="Devolucion" class="form-control" readonly >
    ...
    $(document).on('click', '.update', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('.modal-title').text("Responder permiso");
...
<script >
	...
	$(document).ready(function(){
		...
		readPermisosEmpleado(); /* it will load products when document loads */
    ...
    function readPermisosEmpleado(){
		$('#TablaPermisosEmpleado').load('Tablas/TablaPermisosEmpleado.php');	
	}
