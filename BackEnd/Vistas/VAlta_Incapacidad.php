                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group data-custon-pick">
                                                            ...
                                                            <div class="input-group date">
                                                                ...
                                                                <input type="date" name="DiaInicio" id="DiaInicio" class="form-control" value="<?php echo date("Y-m-d"); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group data-custon-pick">
                                                            ...
                                                            <div class="input-group date">
                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                <input type="date" name="DiaFinal" id="DiaFinal" class="form-control" value="<?php echo date("Y-m-d"); ?>">
                                                            </div>
                                                        </div>
...
//alert(datos);
               ...
               $.ajax({
                   url:"TablasModal/TablaPersonalIncapacidad.php",
                   method:'POST',
                   data:new FormData(this),
                   contentType:false,
                   processData:false,
