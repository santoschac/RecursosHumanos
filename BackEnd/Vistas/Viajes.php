...
<div id="TablaViaje"></div> <!-- products will be load here -->
...
<script >
	...
	$(document).ready(function(){
		...
		readViajes(); /* it will load products when document loads */
		...
		swal({
			...
			preConfirm: function() {
			  return new Promise(function(resolve) {
			     ...
			     $.ajax({
			   		url: "Eliminar/Eliminar_Viaje.php",
			    	type: 'POST',
			       	data: 'delete='+IdViaje,
                    dataType: 'json'
    ...
    function readViajes(){
		$('#TablaViaje').load('Tablas/TablaViaje.php');	
	}
