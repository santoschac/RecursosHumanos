...
<div id="TablaCapacitacionEmpleado"></div> <!-- products will be load here -->
...
<script >
	...
	$(document).ready(function(){
		...
		readCapacitacionEmpleado(); /* it will load products when document loads */
    ...
    function readCapacitacionEmpleado(){
		$('#TablaCapacitacionEmpleado').load('Tablas/TablaCapacitacionEmpleado.php');	
	}
