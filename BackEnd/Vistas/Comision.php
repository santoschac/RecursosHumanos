...
<div id="TablaComision"></div> <!-- products will be load here -->
...
<script >
	...
	$(document).ready(function(){
		...
		readComision(); /* it will load products when document loads */
    ...
    function readComision(){
		$('#TablaComision').load('Tablas/TablaComision.php');	
	}
